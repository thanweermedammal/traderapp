...
class PaymentScreen extends StatefulWidget {
  ...
  PaymentScreen({Key? key, required this.loginList}) : super(key: key);
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  getDatas() async {
    var response = await http.get(Uri.parse(
        'http://185.188.127.100/WaselleApi/api/Payment/GetAllShipperPayment?ShipperId=${widget.loginList.first.shipperId}&BranchId=${widget.loginList.first.branchId}'));
              ...
              itemBuilder: (context, index) => GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PaymentsDetail(
